...
def nme_movement(nme_game):
    ...
    print(rounded)
    #----------- Y axis movement -----------
    print("Resultat is", nme_game.y % 30)
    if nme_game.x == width - nme_w and nme_game.y >= rounded and nme_game.y <= rounded + nme_h:
        nme_game.y += nme_v
    ...
    sep = "|"
    # -----------------------prints---------------
    print("Val is: {}".format(val), sep.center(2), "Ycoord is: {}".format(nme_game.y))
    # -----------------------prints---------------
    while val != 0 and nme_game.y < height - nme_h:
        nme_game.y += nme_v
        break
