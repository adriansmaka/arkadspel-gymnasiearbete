        ...
        while clears < 4:
            ...
            if nme_game.x == 0 and nme_game.y > nme_h * n * 2:
                ...
                if nme_game.x == width - nme_w:
                    print("friohjfpoweufbhqpughfpwoghfqoqpwfqöoeihgöoiqheöoiqghföogqwföoqghwfgqiofhqöoifhqowhfoqwghfqogfqöiweuiofhqwpuof")
                    nleft += 60
            ...
            #Left stop, down start
                ...
                #print(nme_game.x)
                #print(nme_game.y)
            elif nme_game.x == width - nme_w and nme_game.y >= nme_h * n and nme_game.y <  nme_h * n * 3:
                nme_game.y += nme_v
                print("Stage six clears", clears)
                print("Stage six n", n)
                print("Stage six nleft", nleft)
                print(nme_game.x)
                print(nme_game.y)
            break
