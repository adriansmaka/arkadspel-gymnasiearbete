...
triangle = pygame.draw.polygon((window), (255, 255, 0), [(char_x, char_y), (char_x+25, char_y+25), (char_x+50, char_y-50)])

def display_window(char_game, nme_game, triangle):
    window.fill(white)
    pygame.draw.rect(window, black, wall)
    window.blit(char, (char_game.x, char_game.y))
    window.blit(nme, (nme_game.x, nme_game.y))
    window.blit(triangle, (char_game.x, char_game.y))
...
def triangle_hitbox():
    #draws a triangle hitbox
    pygame.draw.polygon((window), (255, 255, 0), [(50,50), (200,70), (200,25)])
...
def main():
    ...
    while run:
        ...
        display_window(char_game, nme_game, triangle)
